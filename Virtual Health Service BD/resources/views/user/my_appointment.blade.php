      ...
      <table>
        ...
        @foreach($appoint as $appoints)
          <tr style="background-color:#99ffcc;" align="center">
              ...
              <td style="padding:20px;"><a class="btn btn-danger" onclick="return confirm('Are you sure to delete the appointment')" href="{{url('cancel_appoint',$appoints->id)}}">Cancel Appointment</td>
          </tr>
          @endforeach
